...
Usage:
    ...
    python3 recorder/replay_episode.py path/to/episode_0.hdf5

    # Pick episode from a dataset directory (defaults to episode 0):
    python3 recorder/replay_episode.py path/to/dataset_20260227/

    # Pick a specific episode index from a directory:
    python3 recorder/replay_episode.py path/to/dataset_20260227/ -e 3
